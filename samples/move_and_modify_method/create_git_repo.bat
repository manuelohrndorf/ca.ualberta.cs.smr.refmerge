...
SET "PATH_MAIN_1=move_and_modify_method.repository_plain\main\1"
FOR %%I IN ("%PATH_MAIN_1%") DO SET "PATH_MAIN_1=%%~fI"

SET "PATH_MAIN_2=move_and_modify_method.repository_plain\main\2"
FOR %%I IN ("%PATH_MAIN_2%") DO SET "PATH_MAIN_2=%%~fI"

SET "PATH_BRANCH_A_1_3=move_and_modify_method.repository_plain\branchA\1-3"
FOR %%I IN ("%PATH_BRANCH_A_1_3%") DO SET "PATH_BRANCH_A_1_3=%%~fI"

SET "REPO_NAME=move_and_modify_method.repository"
