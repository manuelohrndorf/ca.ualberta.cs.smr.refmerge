...
# Define paths
PATH_MAIN_1=$(realpath "pull_up_and_move_method.repository_plain/main/1")
PATH_MAIN_2=$(realpath "pull_up_and_move_method.repository_plain/main/2")
PATH_BRANCH_A_1_3=$(realpath "pull_up_and_move_method.repository_plain/branchA/1-3")
REPO_NAME="pull_up_and_move_method.repository"
