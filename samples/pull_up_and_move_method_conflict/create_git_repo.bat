...
SET "PATH_MAIN_1=pull_up_and_move_method_conflict.repository_plain\main\1"
FOR %%I IN ("%PATH_MAIN_1%") DO SET "PATH_MAIN_1=%%~fI"

SET "PATH_MAIN_2=pull_up_and_move_method_conflict.repository_plain\main\2"
FOR %%I IN ("%PATH_MAIN_2%") DO SET "PATH_MAIN_2=%%~fI"

SET "PATH_BRANCH_A_1_3=pull_up_and_move_method_conflict.repository_plain\branchA\1-3"
FOR %%I IN ("%PATH_BRANCH_A_1_3%") DO SET "PATH_BRANCH_A_1_3=%%~fI"

SET "REPO_NAME=pull_up_and_move_method_conflict.repository"
